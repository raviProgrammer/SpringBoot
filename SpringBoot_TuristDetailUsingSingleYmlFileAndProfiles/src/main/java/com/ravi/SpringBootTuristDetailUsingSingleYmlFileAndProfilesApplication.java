...
public class SpringBootTuristDetailUsingSingleYmlFileAndProfilesApplication {
	@Bean(name="c3p0Ds")
	@Profile("uat")
	...
	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(SpringBootTuristDetailUsingSingleYmlFileAndProfilesApplication.class, args);
